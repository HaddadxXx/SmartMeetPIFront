...
import { AboutProfileBoxComponent } from '../../favorite-about/about-profile-box/about-profile-box.component';
@Component({
  selector: 'app-about-data',
  templateUrl: './about-data.component.html',
  styleUrl: './about-data.component.scss',
  imports: [FeatherIconComponent,AboutProfileBoxComponent],
  standalone: true
})
