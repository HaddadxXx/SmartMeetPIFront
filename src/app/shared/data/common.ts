...
export const stories = [
     {
          url: 'assets/images/user-sm/1.jpg',
     ...
     {
          url: 'assets/images/user-sm/3.jpg',
          username: 'Paul Molive',
          time: 5,
          class: ''
     },
     {
          url: 'assets/images/user-sm/4.jpg',
          username: 'Anna Mull',
          time: 5,
          class: ''
     },
...
export const emoji = [
     {
          images: 'assets/svg/emoji/040.svg'
     },
     {
          images: 'assets/svg/emoji/113.svg'
     },
     {
          images: 'assets/svg/emoji/027.svg'
     },
     {
          images: 'assets/svg/emoji/033.svg'
     },
]
...
export const emojiList = [
     ...
     {
          icon: 'wow',
          images: 'assets/svg/emoji/052.svg'
     },
     {
          icon: 'angry',
          images: 'assets/svg/emoji/039.svg'
     },
     {
          icon: 'haha',
...
export const comment = [
     {
          images: 'assets/images/user-sm/2.jpg',
          uname: 'Pabelo Mukrani',
          comment: 'Oooo Very Cute and Sweet Dog, happy birthday Cuty....',
          likes: 5,
          reply: [
               {
                    images: 'assets/images/user-sm/3.jpg',
                    uname: 'sufiya elija',
                    comment: 'Thank You So Much ❤❤',
                    likes: 0,
               },
               {
                    images: 'assets/images/user-sm/4.jpg',
                    uname: 'sufiya elija',
                    comment: 'Thank You So Much ❤❤',
                    likes: 0,
               },
     ...
     },
     {
          images: 'assets/images/user-sm/2.jpg',
          uname: 'Pabelo Mukrani',
          comment: 'It’s party time, Sufiya..... and happy birthday cuty 🎉🎊',
          likes: 0,
     },
]

export const sharedPostIcon= [
     {
          icon: 'globe',
          name: 'public'
     },
